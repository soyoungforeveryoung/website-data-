...
| 항목 | 값 | 출처 |
|---|---|---|
| 조향 | 파운더 조소영(Soyoung Cho)과 **Chemia**의 공동 개발 | `소영` (2026-09-13) |
| 향료사 | **Chemia Corporation** | `소영` |
| 향료 | `84033 ROSE BUD` | IFRA 인증서 |

Chemia는 **이 로즈 향 하나만** 취급한다. 다른 콜렉션에는 관여하지 않는다.
캔들과 바디가 **같은 향료 하나**를 쓰는 유일한 콜렉션이기도 하다.
