...
**향 노트** (확정)
> Basil, Spearmint, Sage, Coriander, Immortelle, Sandalwood, Tonka, Amber

⚠️ 현재 사이트에는 이 노트와 별개로 Elemi, Oakmoss, Fir balsam을 언급한 서술형 설명이
따로 있어 서로 맞지 않는다. **어느 쪽이 정본인지 확정 필요.**
