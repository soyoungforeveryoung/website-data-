# 솔드아웃 · 단종 제품 정리 (Phase 2)

2026년 말까지는 코어 6종만 판매한다. 나머지는 shop list에서 내린다.

## 코어 6종 (유지)

| 제품 | 상태 | 재고 |
|---|---|---|
| Bamboo Forest Scented Candle | ACTIVE | 19 |
| Bushman Candle Scented Candle | ACTIVE | 30 |
...
→ 세트는 코어 6종으로 구성되므로 **유지 권장**. 소영님 확인 필요.

## 정리 대상 (ACTIVE 아님 — shop list 노출 여부 점검)

DRAFT 상태지만 컬렉션/검색에 남아있을 수 있는 항목:
디퓨저 4종 및 리필 4종, 메탈 디퓨저 리드, 배스솔트류, 바디워시·로션,
Packable Shopper, Redvanly 리미티드 에디션, K-Bath Ritual 세트

→ Phase 1(원장 확정) 완료 후 착수.
